(()=>{
  ...
  function admin3(){
    ...
    const loadHeroPhotos=()=>{
      const photos={jp:'https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&w=520&q=62',uk:'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=520&q=62',es:'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?auto=format&fit=crop&w=520&q=62'};
      Object.entries(photos).forEach(([cls,url])=>{const el=hero.querySelector('.'+cls);if(el)el.style.backgroundImage=`url("${url}")`});
    };
    if('requestIdleCallback' in window)requestIdleCallback(loadHeroPhotos,{timeout:1200});else setTimeout(loadHeroPhotos,350);
    ...
    const photos={
      'España':'https://images.unsplash.com/photo-1539037116277-4db20889f2d4?auto=format&fit=crop&w=720&q=68',
      'Chile':'https://images.unsplash.com/photo-1518509562904-e7ef99cdcc86?auto=format&fit=crop&w=720&q=68',
      'Reino Unido':'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=720&q=68',
      'Japón':'https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&w=720&q=68',
      'Corea del Sur':'https://images.unsplash.com/photo-1538485399081-7c8971d6dcaf?auto=format&fit=crop&w=720&q=68',
      'China':'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?auto=format&fit=crop&w=720&q=68',
      'Turquía':'https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?auto=format&fit=crop&w=720&q=68',
      'Singapur':'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?auto=format&fit=crop&w=720&q=68'
    };
